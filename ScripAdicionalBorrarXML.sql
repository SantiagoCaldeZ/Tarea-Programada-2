...
delete from dbo.Movimiento --7
delete from dbo.Empleado --6
delete from dbo.Puesto --1
delete from dbo.TipoEvento --2
delete from dbo.TipoMovimiento --3
delete from dbo.Usuario --4
delete from dbo.Error --5
